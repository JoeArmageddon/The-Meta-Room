...
-- Update entries type constraint to include new types
...
-- Add new columns to ai_explanations
DO $$
BEGIN
...
-- Add new columns to relationships
DO $$
BEGIN
...
-- Update relationship_type constraint
...
-- Create trigger for collection entry count
...
-- Create trigger for entry rating average
...
-- Insert seed data for collections (if empty)
...
-- Insert seed data for learning paths (if empty)
